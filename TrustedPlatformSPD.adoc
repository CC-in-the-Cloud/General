...
the Assumption      |Cloud Authorization scheme Controls
|A.TRUSTED_PLATFORM_ADMINISTRATOR    |OE.TRUSTED_PLATFORM_ADMINISTRATOR      |a
|A.TRUSTED_PLATFORM_CONNECTIVITY    |OE.TRUSTED_PLATFORM_CONNECTIVITY      |a
|A.TRUSTED_PLATFORM_ISOLATON    |OE.TRUSTED_PLATFORM_ISOLATON      |a
|A.TRUSTED_PLATFORM_PHYSICAL_PROTECTION    |OE.TRUSTED_PLATFORM_PHYSICAL_PROTECTION      |a
|A.TRUSTED_PLATFORM_REGULAR_UPDATES    |OE.TRUSTED_PLATFORM_REGULAR_UPDATES      |a
|A.TRUSTED_PLATFORM_RESIDUAL_INFORMATION    |OE.TRUSTED_PLATFORM_RESIDUAL_INFORMATION      |a
|A.TRUSTED_PLATFORM_SERVICE    |OE.TRUSTED_PLATFORM_SERVICE, OE.TIMESTAMP      |a
|=======================
