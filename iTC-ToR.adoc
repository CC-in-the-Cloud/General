...
* Canadian Centre for Cyber Security Communications Security Establishment, contact@cyber.gc.ca
* National Information Assurance Partnership (NIAP), niap@niap-ccevs.org
...
// Define Major and Minor Decisions //
// Start Here //
