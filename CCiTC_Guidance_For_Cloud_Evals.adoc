...
*** This should be for how your cloud platform management plane is set up to allow for the product (esxi config/kubernetes config/etc)
*** Platform Isolation
** Env. Variables
...
** Token generation
* Uninstallation/Destruction Guidance
** Secret Wipes
** Data santization
