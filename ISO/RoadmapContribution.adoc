...
Review and monitor relevant Cloud Security Frameworks will be considered to capture additional threat considerations or assurance requirements. The following items were identified as particularly relevant for CC in the Cloud efforts.
