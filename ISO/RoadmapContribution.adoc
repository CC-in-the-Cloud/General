...
The following PPs are examples which might be extended with CCitC methodology to cover the above use case: GP_OS_PP, cPP_ND.
...
In February 2022, an 'Essential Security Requirement' document was produced as required for this group to become an official International Technical Community under the CCMC (Common Criteria Management Committee). Consequently, the group expect to develop a guidance document that can be an input for this topic for ISO/IEC15408. 
