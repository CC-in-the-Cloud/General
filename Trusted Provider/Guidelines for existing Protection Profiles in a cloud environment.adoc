...
=== A Composition with existing PP’s
...
An Application, Or Network Device
...
=== Protection Profiles of interest
...
== Analysis of the Assumptions and Security Objectives of the Operating Environment for an example stack of PP’s
...
== Steps to optimise a PP for TOEs in a cloud environment.
